...
TOOLS="--tools statistics_analysis evaluate_formula submit_formula polynomial_fit code_executor predict_property"
EXP="prop_tool_compare_with_prop"

echo "[$(date)] START WITH PROP"
